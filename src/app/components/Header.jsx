...
//                     <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-3 px-6 rounded-full shadow-lg hover:scale-105 transition-transform duration-300">
//                         Get Unlimited Downloads
//                     </button>
//                 </nav>

//                 {/* Search Bar */}
//                 <div className="hidden md:flex items-center space-x-3 border border-gray-300 rounded-full px-3 py-1">
//                     <select
...
//                         <FiShoppingCart size={22} className="text-gray-800 hover:text-blue-600" />
...
//                     <Link href="/about" className="block text-gray-800 hover:text-blue-600">About Us</Link>
//                     <Link href="/categories" className="block text-gray-800 hover:text-blue-600">Categories</Link>
