...
const MegaMenu = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mega Menu Dropdown */}
      <div
        className={`absolute left-1/3  -translate-x-1/3 w-screen bg-white/80 backdrop-blur-lg shadow-xl border border-gray-200 rounded-xl p-6 grid grid-cols-2 md:grid-cols-4 gap-6 transition-all duration-300 transform ${isOpen ? "scale-100 opacity-100" : "scale-95 opacity-0 pointer-events-none"
          }`}
      >
